...
<%-- 	<table>
			<tbody>
				...
				<tr>
					...
					<td class="fixed">${goods.goods_total_page}kg</td>
				</tr>
				<tr class="dot_line">
...
<!-- 		<li><a href="#tab1">책소개</a></li>
			...
			<li><a href="#tab2">상세정보</a></li>
			<li><a href="#tab3">상품후기</a></li>
			<li><a href="#tab4">상품문의</a></li>
		</ul>
		<div class="tab_container">
			...
			<div class="tab_content" id="tab2">
				...
				<div class="writer">${goods.goods_writer}의 상세정보 </div>
