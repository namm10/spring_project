...
<style>
/*필수입력사항*/
#m1{text-align: center; color:#333; font-size:20px; margin-bottom:30px;}
/*제목들*/
#detail_table table td.fixed_join{background:#fff; color:#333; text-align:center;}

#detail_table table tr.dot_line{border-bottom-style:solid;}
/*테이블 전체*/
#m2{margin-left:300px; margin-bottom:100px;}
#m2 input{outline:none;}
/*중복체크*/
#btnOverlapped{border:none; width:80px; height:20px; background:#93cec5; color:#fff; 
border-radius:50px;}
/*회원가입*/
#m3{width:100px; height:30px; margin-left:200px; background-color:#93cec5; border:none; 
border-radius:50px; color:#fff; font-weight:bold;}
/*다시입력*/
#m4{width:100px; height:30px; background-color:#93cec5; border:none; 
border-radius:50px; color:#fff; font-weight:bold;}
/*우편번호검색*/
...
<body>
	<h3 id="m1">필수입력사항</h3>
	<form action="${contextPath}/member/addMember.do" method="post" id="m2">	
	<div id="detail_table">
		<table>
			<tbody>
				<tr class="dot_line">
		...
		<tr>
			<td >
				<input type="submit"  value="회원 가입" id="m3">
				<input  type="reset"  value="다시입력" id="m4">
			</td>
		</tr>
	</table>
	</div>
