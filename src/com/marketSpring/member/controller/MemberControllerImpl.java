package com.marketSpring.member.controller;
...
public class MemberControllerImpl extends BaseController implements MemberController{
	...
	public ModelAndView login(@RequestParam Map<String, String> loginMap,
		...
		if (memberVO != null && memberVO.getMember_id() != null) {
			...
			if (action != null && action.equals("/order/orderEachGoods.do")) {
				...
				mav.setViewName("forward:" + action);
			} else if (action != null && action.equals("/board/replyForm.do")) {
				mav.setViewName("redirect:" + action);
			} else if (action != null && action.equals("/board/freeBo/freeBoardForm.do")) {
				mav.setViewName("forward:" + action);
			} else if (action != null && action.equals("/board/freeBo/replyForm.do")) {
				mav.setViewName("redirect:" + action);
			} else {
	...
	public ResponseEntity addMember(@ModelAttribute("memberVO") MemberVO _memberVO,
		...
		try {
		    ...
		    message  = "<script>";
		    message +=" alert('가입을 성공하였습니다.');";
		    message += " location.href='"+request.getContextPath()+"/member/loginForm.do';";
		    message += " </script>";
		    
		}catch(Exception e) {
			message  = "<script>";
		    message +=" alert('가입을 실패하였습니다.');";
