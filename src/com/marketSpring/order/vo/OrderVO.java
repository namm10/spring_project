package com.marketSpring.order.vo;
...
public class OrderVO {
	...
	private int order_goods_size;//최종 주문  제품 수
	...
	// sy) 배송지 정보를 나눠서 저장(우편번호, 도로명, 지번, 상세주소)
	private String delivery_zipcode;		// 배송 우편번호
	private String delivery_roadAddress;	// 배송 도로명 주소
	private String delivery_jibunAddress;	// 배송 지번 주소
	private String delivery_namujiAddress;	// 배송 상세 주소
	...
	public String getDelivery_roadAddress() {
		return delivery_roadAddress;
	}
	public void setDelivery_roadAddress(String delivery_roadAddress) {
		this.delivery_roadAddress = delivery_roadAddress;
	}
	public String getDelivery_jibunAddress() {
		return delivery_jibunAddress;
	}
	public void setDelivery_jibunAddress(String delivery_jibunAddress) {
		this.delivery_jibunAddress = delivery_jibunAddress;
	}
	public String getDelivery_namujiAddress() {
		return delivery_namujiAddress;
	}
	public void setDelivery_namujiAddress(String delivery_namujiAddress) {
		this.delivery_namujiAddress = delivery_namujiAddress;
	}
